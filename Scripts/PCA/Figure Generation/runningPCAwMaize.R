...
#Meant for making PCA plots with maize
#Created by David E. Hufnagel

#set working directory here
data = read.table("ZeaAllInfo.pmz.PCAmatrix.wMz", row.names=1, skip=1) #SNP file used to subset
